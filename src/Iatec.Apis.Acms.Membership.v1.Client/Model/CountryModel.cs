...
namespace Iatec.Apis.Acms.Membership.v1.Client.Model
{
    ...
    public partial class CountryModel :  IEquatable<CountryModel>, IValidatableObject
    {
        ...
        public CountryModel(string Id = default(string), string Code = default(string), string Name = default(string), double? LatitudeNumber = default(double?), double? LongitudeNumber = default(double?), string FormattedName = default(string), string Abbreviation = default(string))
        {
            this.Id = Id;
            this.Code = Code;
            this.Name = Name;
