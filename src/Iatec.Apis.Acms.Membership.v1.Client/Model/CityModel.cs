...
namespace Iatec.Apis.Acms.Membership.v1.Client.Model
{
    ...
    public partial class CityModel :  IEquatable<CityModel>, IValidatableObject
    {
        ...
        public CityModel(string Id = default(string), string Code = default(string), string Name = default(string), string PhoneticName = default(string), double? LatitudeNumber = default(double?), double? LongitudeNumber = default(double?), string FormattedName = default(string), StateModel State = default(StateModel), CountryModel Country = default(CountryModel))
        {
            this.Id = Id;
            this.Code = Code;
            this.Name = Name;
