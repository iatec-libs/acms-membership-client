...
namespace Iatec.Apis.Acms.Membership.v1.Client.Client
{
    ...
    public class Configuration
    {
        ...
        public Configuration(ApiClient apiClient = null,
                             ...
                             int timeout = 100000,
                             string userAgent = "Swagger-Codegen/1.0.1.2/csharp"
                            )
        {
        ...
        {
            String report = "C# SDK (Iatec.Apis.Acms.Membership.v1.Client) Debug Report:\n";
            ...
            report += "    SDK Package Version: 1.0.1.2\n";
